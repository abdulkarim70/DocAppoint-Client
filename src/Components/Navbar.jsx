      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link
              href="/register"
              className="bg-cyan-500 hover:bg-cyan-600 text-white px-5 py-2 rounded-xl font-medium shadow-md transition hover:scale-105"
            >
              Register
            </Link>
          </div>
        ...
        {/* Mobile Menu */}
        {open && (
          <div className="md:hidden py-5 border-t animate-in slide-in-from-top">
